...
export default function SlideFormDealActiveEdit({deal}) {
    ...
    const handleSubmitForm = async (data) => {
        ...
        try {
            ...
            await api.put('/deal/active/'+ deal.id, data);
    ...
    return (
        <>
            ...
            <button
                type="button"
                className="w-full my-2 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                        ...
                                        <div className="px-4 sm:px-6">
                                            <div className="flex items-start justify-between">
                                                <Dialog.Title className="text-base font-semibold leading-6 text-gray-900">
                                                   Atualizar Negócio (ativar/desativar)
                                                </Dialog.Title>
                                                        ...
                                                        <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                            <div className="sm:col-span-4">
                                                                ...
                                                                <div className="mt-2">
                                                                    ...
                                                                    <span className="inline-flex text-sm text-red-700">{errors.active?.message}</span>
                                                                </div>
                                                            </div>
