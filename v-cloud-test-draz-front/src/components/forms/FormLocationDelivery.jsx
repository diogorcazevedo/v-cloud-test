...
export function FormLocationDelivery({deal , user}) {
    ...
    const handleSubmitForm = async (data) => {
        ...
        try {
            ...
            const res = await api.put('/register/updateLocation/'+ user.id, data);
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8">
                ...
                <form onSubmit={handleSubmit(handleSubmitForm)} className="bg-white shadow-sm ring-1 ring-gray-900/5 ">
                    <div className="px-4 py-4">
                        <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="col-span-full">
                                <h3 className="text-base font-semibold leading-6 text-gray-900">Confirmar endereço de entrega</h3>
                            </div>
                            <div className="col-span-full">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        defaultValue={user.location.zip_code}
                                        {...register("zip_code")}
                                        type="text"
                                        name="zip_code"
                                        id="zip_code"
